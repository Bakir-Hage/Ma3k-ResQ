    ...
    return (
        <section className="emergency-section">
            ...
            <div className="emergency-content">
                ...
                <p className="emergency-subtitle">Contact us now via WhatsApp or direect call</p>
                <div className='emergency-buttons'>
                <a href='tel:+972509091031' className='call-button'>Call Now</a>
                <a href='https://wa.me/+972509091031'
                   target="-blank"
